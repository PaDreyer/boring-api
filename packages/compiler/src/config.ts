...
export function formatDiagnostics(diagnostics: readonly ts.Diagnostic[], root: string): string {
    return ts.formatDiagnosticsWithColorAndContext(diagnostics, formatHost(root));
}
